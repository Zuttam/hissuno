...
If you are self-hosting Hissuno and want to use OAuth for Intercom, you need to create your own Intercom app. See the [Self-Hosting Integration Setup](/docs/integrations/self-hosting-setup#intercom) guide for instructions. Alternatively, you can use an Intercom Access Token directly without any server-side configuration.
