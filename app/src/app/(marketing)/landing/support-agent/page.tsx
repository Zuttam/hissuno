...
export const metadata: Metadata = {
  title: 'Hissuno Agent - AI That Drives Retention',
  description:
    'The Hissuno Agent is grounded in your codebase to cut resolution time, reduce support costs, and turn every interaction into a retention opportunity.',
}
