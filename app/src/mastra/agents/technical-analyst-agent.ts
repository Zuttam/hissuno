...
4. Identify specific files that would likely need changes
...
- Identify which system areas would be affected
...
\`\`\`json
{
  "impactAnalysis": {
    "affectedAreas": [
      { "area": "Area name or module", "category": "technical|product|business", "relevance": 0.0-1.0 }
    ],
    "impactScore": 1-5,
...
- **technical**: Code, infrastructure, performance, architecture
- **product**: User-facing features, UI/UX, workflows
- **business**: Pricing, billing, legal, compliance
