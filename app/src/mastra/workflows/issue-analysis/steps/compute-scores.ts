...
import { updateIssueAnalysis } from '@/lib/db/queries/issues'
...
export const computeScores = createStep({
  ...
  execute: async ({ inputData, mastra, writer }) => {
    ...
    await updateIssueAnalysis(issueId, updateData)
    ...
    return {
      ...
      riceScore,
      priority,
      briefGenerated: false, // generate-brief step handles this
      codebaseLeaseId,
