 ...
 *
 * Tools for analysis agents (PM Agent, Brief Writer) to access project knowledge
 * at the source level - no package scoping.
 *
 ...
 */
export const semanticSearchKnowledgeToolV2 = createTool({
...
/** All analysis knowledge tools */
export const analysisKnowledgeTools = [
  listKnowledgeItemsTool,
  getKnowledgeContentTool,
  getKnowledgeSourceDetailTool,
  semanticSearchKnowledgeToolV2,
]
