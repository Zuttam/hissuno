    ...
    <section className="relative overflow-hidden px-6 md:px-12">
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, ease: WATER_EASINGS.float, delay: 0.5 }}
          className="mt-8 inline-flex items-center gap-2 rounded-full border border-[var(--accent-teal)]/30 bg-[var(--surface)]/60 px-4 py-2 backdrop-blur-sm"
        >
          <span className="font-mono text-2xl font-bold text-[var(--accent-teal)]">&lt; 24h</span>
          <span className="text-sm text-[var(--text-secondary)]">average time to PR</span>
        </motion.div>
