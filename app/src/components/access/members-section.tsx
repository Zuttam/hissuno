...
import { removeMember, updateMemberRole } from '@/lib/api/members'
...
export function MembersSection({ projectId, members, isLoading, onRefresh, isOwner }: MembersSectionProps) {
  ...
  const handlePromote = async (memberId: string) => {
    ...
    try {
      await updateMemberRole(projectId, memberId, 'owner')
      await onRefresh()
    } catch (err) {
      console.error('[access.members] Promote error:', err)
    } finally {
      setPromotingId(null)
    }
  }
