...
export const searchCommand = new Command('search')
  ...
  .option('--type <type>', 'Limit to one resource type (feedback|issues|customers|scopes|knowledge|codebase)')
  ...
  .action(async (query, opts, cmd) => {
    ...
    if (opts.type) {
      const validTypes = ['feedback', 'issues', 'customers', 'scopes', 'knowledge', 'codebase']
