...
5. eventually (once all data is present) the agent will start a workflow where it prepares a feature request spec which the developer can approve (in hissuno dashboard) 
