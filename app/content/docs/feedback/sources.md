...
The Hissuno widget is an embeddable chat component that you add to your website or application. It provides a direct channel for customers to interact with the Hissuno Agent.
...
4. The Hissuno Agent responds in real time using your project's knowledge packages
