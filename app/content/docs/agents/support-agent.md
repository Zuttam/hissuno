---
title: "Hissuno Agent"
description: "Learn how the Hissuno Agent uses product knowledge to handle customer conversations and escalate when needed."
---
...
The Hissuno Agent maintains full conversation context throughout a session. It remembers previous messages, follows up on earlier topics, and avoids repeating itself. The context window includes:
...
The Hissuno Agent is typically deployed through the Hissuno widget. Widget appearance and behavior are configured separately on the **Integrations** page -- navigate to **Integrations** in the sidebar and click **Configure** on the Widget card.

## Monitoring Performance

Track how well the Hissuno Agent is handling conversations from the **Dashboard** page. Key metrics include:
