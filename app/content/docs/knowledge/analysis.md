...
The saved packages are split into chunks and each chunk is converted to a vector embedding for semantic search. This indexing enables the Hissuno Agent to find the most relevant knowledge when answering customer questions.
