...
description: "Add and manage the data sources that power your AI support agent's understanding of your product."
---

## Overview

Knowledge sources are the raw inputs that Hissuno analyzes to build your AI support agent's understanding of your product. By connecting your codebase, documentation, and other materials, you give the agent the context it needs to answer customer questions accurately.
...
- When analysis runs, packages are generated per named package, and the support agent can reference the appropriate package based on context
...
- **Re-run analysis** after significant product changes to keep the support agent current
